      ...
      <div className="Battle-container">
        ...
        <div className="battleText">
          ...
          <h4>
            ...
            <h2 className="tituloFuente">Reglas del concurso: </h2>
            ...
            * Registrarse en esta Web antes de la fecha indicada. <br />
            ...
            <h2 className="tituloFuente">Premios: </h2>
            ...
            * Blackbook formato, Lote de pegatinas, Pack de lapices y figura de
            ...
            <h2 className="tituloFuente">Requisitos:
 </h2>
            ...
            pagina con el titular ‘Sketch Battle’
                      <br />
                    <h2 className="tituloFuente">Jueces:
 </h2>  
AliciaNuro - 
Sig. Luigi - 
SoldOne
