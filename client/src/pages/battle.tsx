    ...
    <>
      ...
      <div className="Battle-container">
        ...
        <div className="battleText">
          ...
          <br />
          <h4>
            A lo largo del año realizaremos varios Sketch Battles , donde
            ...
            <h2>Requisitos:</h2>
            <br />
            Seguirnos en la página de Instagram y registrase en esta Web. Subir
            ...
            <br />
            <h2>Premios: (se anunciaran pronto...)</h2>
            <br />
