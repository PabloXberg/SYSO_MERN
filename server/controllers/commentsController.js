...
const deleteComment = async (req, res) => {
  try {
    ...
    const updatedUser = await deleteCommentToUser(
      req.body.owner,
      deletedComment
    );
    const updatedSketch = await deleteCommentToSketch(
      req.body.sketch,
      deletedComment
    );
...
const createComment = async (req, res) => {
  ...
  try {
    ...
    const updatedUser = await addCommentToUser(
      req.body.owner,
      registeredComment
    );
    const updatedSketch = await addCommentToSketch(
      req.body.sketch,
      registeredComment
    );
